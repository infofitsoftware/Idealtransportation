...
export default function UserManagementPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      {showForm && (
        <div className="mb-6 bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6 border border-blue-100 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="is_superuser" className="ml-2 block text-sm text-gray-700 dark:text-gray-300">
      ...
      {/* Users Table */}
      <div className="bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden border border-blue-100 dark:border-gray-700">
