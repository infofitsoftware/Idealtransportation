    ...
    return (
      <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-gray-900">Recent BOLs</h3>
        </div>
    ...
    return (
      <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-500">No BOLs found</p>
        </div>
      </div>
    );
  }
        ...
        {bols.map((bol) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <EyeIcon className="h-5 w-5 text-gray-400 ml-2 flex-shrink-0" />
            </div>
          </Link>
        ))}
      </div>
